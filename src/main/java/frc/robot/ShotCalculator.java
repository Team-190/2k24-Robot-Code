...
public class ShotCalculator {
  ...
  static {
    ...
    shooterSpeedMap.put(3.89, 900.0);

    // Units: radians
    shooterAngleMap.put(2.45, 0.025);
    shooterAngleMap.put(2.69, 0.06);
    shooterAngleMap.put(2.84, 0.36);
    shooterAngleMap.put(2.98, 0.38);
    shooterAngleMap.put(3.19, 0.42);
    shooterAngleMap.put(3.52, 0.46);
    shooterAngleMap.put(3.89, 0.47);
