...
public class IntakeIOTalonFX implements IntakeIO {
    ...
    public void updateInputs(IntakeIOInputs inputs) {
        ...
        inputs.intakeVelocityRadiansPerSecond = Units
                .rotationsToRadians(intakeVelocityRadiansPerSecond.getValueAsDouble());
        ...
        inputs.serializerVelocityRadiansPerSecond = serializerVelocityRadiansPerSecond.getValueAsDouble();
