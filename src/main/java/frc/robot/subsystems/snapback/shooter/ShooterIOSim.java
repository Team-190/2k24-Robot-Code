...
public class ShooterIOSim implements ShooterIO {
    ...
    public ShooterIOSim() {
        leftFlywheelMotorSim = new DCMotorSim(
                LinearSystemId.createDCMotorSystem(ShooterConstants.FLYWHEEL_MOTOR, 0.004,
                        ShooterConstants.FLYWHEEL_GEAR_RATIO),
                ShooterConstants.FLYWHEEL_MOTOR, 0.004);
        rightFlywheelMotorSim = new DCMotorSim(
                LinearSystemId.createDCMotorSystem(ShooterConstants.FLYWHEEL_MOTOR, 0.004,
                        ShooterConstants.FLYWHEEL_GEAR_RATIO),
                ShooterConstants.FLYWHEEL_MOTOR, 0.004);
        acceleratorMotorSim = new DCMotorSim(
                LinearSystemId.createDCMotorSystem(ShooterConstants.ACCELERATOR_MOTOR, 0.004,
                        ShooterConstants.ACCELERATOR_GEAR_RATIO),
                ShooterConstants.ACCELERATOR_MOTOR, 0.004);
    ...
    public void updateInputs(ShooterIOInputs inputs) {
        ...
        inputs.leftVelocityErrorRadiansPerSecond = leftFlywheelVelocitySetpoint - leftFlywheelMotorSim.getAngularVelocityRadPerSec();
        ...
        inputs.rightVelocityErrorRadiansPerSecond = rightFlywheelVelocitySetpoint - rightFlywheelMotorSim.getAngularVelocityRadPerSec();
        ...
        inputs.acceleratorPosition = Rotation2d.fromRadians(acceleratorMotorSim.getAngularPositionRad());
