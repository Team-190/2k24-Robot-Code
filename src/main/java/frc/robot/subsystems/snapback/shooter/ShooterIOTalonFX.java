...
public class ShooterIOTalonFX implements ShooterIO {
    ...
    private final Alert leftDisconnectedAlert = new Alert("Shooter left Talon is disconnected, check CAN bus.",
            AlertType.ERROR);
    private final Alert rightDisconnectedAlert = new Alert("Shooter right Talon is disconnected, check CAN bus.",
            AlertType.ERROR);
    private final Alert acceleratorDisconnectedAlert = new Alert(
            "Shooter accelerator Talon is disconnected, check CAN bus.", AlertType.ERROR);
    ...
    public void updateInputs(ShooterIOInputs inputs) {
        boolean leftConnected = BaseStatusSignal.refreshAll(
                leftPosition,
                leftVelocityRotationsPerSecond,
                leftVelocitySetpointRadiansPerSecond,
                leftVelocityErrorRadiansPerSecond,
                ...
                leftTemperatureCelsius)
                .isOK();
        boolean rightConnected = BaseStatusSignal.refreshAll(
                rightPosition,
                rightVelocityRotationsPerSecond,
                rightVelocitySetpointRadiansPerSecond,
                rightVelocityErrorRadiansPerSecond,
                ...
                rightTemperatureCelsius)
                .isOK();
        boolean acceleratorConnected = BaseStatusSignal.refreshAll(
                acceleratorPosition,
                acceleratorVelocityRotationsPerSecond,
                acceleratorAppliedVolts,
                acceleratorCurrentAmps,
        ...
        inputs.leftVelocityRadiansPerSecond = Units
                .rotationsToRadians(leftVelocityRotationsPerSecond.getValueAsDouble());
        ...
        inputs.leftVelocityGoalRadiansPerSecond = Units
                .rotationsToRadians(leftVelocitySetpointRadiansPerSecond.getValueAsDouble());
        inputs.leftVelocityErrorRadiansPerSecond = Units
                .rotationsToRadians(leftVelocityErrorRadiansPerSecond.getValueAsDouble());

        inputs.rightPosition = Rotation2d.fromRotations(rightPosition.getValueAsDouble());
        inputs.rightVelocityRadiansPerSecond = Units
                .rotationsToRadians(rightVelocityRotationsPerSecond.getValueAsDouble());
        ...
        inputs.rightVelocityGoalRadiansPerSecond = Units
                .rotationsToRadians(rightVelocitySetpointRadiansPerSecond.getValueAsDouble());
        inputs.rightVelocityErrorRadiansPerSecond = Units
                .rotationsToRadians(rightVelocityErrorRadiansPerSecond.getValueAsDouble());

        inputs.acceleratorPosition = Rotation2d.fromRotations(acceleratorPosition.getValueAsDouble());
        inputs.acceleratorVelocityRadiansPerSecond = Units
                .rotationsToRadians(acceleratorVelocityRotationsPerSecond.getValueAsDouble());
