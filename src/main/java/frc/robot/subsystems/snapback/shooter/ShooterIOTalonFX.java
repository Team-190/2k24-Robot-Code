...
public class ShooterIOTalonFX implements ShooterIO {
  ...
  public StatusSignal<Double> leftVelocityRadiansPerSecond;
  public StatusSignal<Double> leftAppliedVolts;
  public StatusSignal<Double> leftCurrentAmps;
  public StatusSignal<Double> leftTemperatureCelsius;

  private final TalonFX rightFlywheel;
  public StatusSignal<Double> rightPosition;
  public StatusSignal<Double> rightVelocityRadiansPerSecond;
  public StatusSignal<Double> rightAppliedVolts;
  public StatusSignal<Double> rightCurrentAmps;
  public StatusSignal<Double> rightTemperatureCelsius;

  private final TalonFX accelerator;
  public StatusSignal<Double> acceleratorPosition;
  public StatusSignal<Double> acceleratorVelocityRadiansPerSecond;
  public StatusSignal<Double> acceleratorAppliedVolts;
  public StatusSignal<Double> acceleratorCurrentAmps;
  public StatusSignal<Double> acceleratorTemperatureCelsius;
  ...
  public ShooterIOTalonFX() {
    ...
    TalonFXConfiguration flywheelConfig = config;
    ...
    TalonFXConfiguration acceleratorConfig = config;
