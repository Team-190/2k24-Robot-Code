...
public class HoodConstants {
    ...
    public static final LoggedTunableNumber STOWED_POSITION = new LoggedTunableNumber("Hood/Stowed Position");
    public static final LoggedTunableNumber AMP_POSITION = new LoggedTunableNumber("Hood/Amp Position");
    public static final LoggedTunableNumber SOURCE_SIDE_FEED_POSITION = new LoggedTunableNumber("Hood/Source Side Feed Position");
    public static final LoggedTunableNumber AMP_SIDE_FEED_POSITION = new LoggedTunableNumber("Hood/Amp Side Feed Position");
    public static final LoggedTunableNumber MIN_POSITION = new LoggedTunableNumber("Hood/Minimum Angle");
    public static final LoggedTunableNumber MAX_POSITION = new LoggedTunableNumber("Hood/Maximum Angle");
    public static final LoggedTunableNumber GOAL_TOLERANCE = new LoggedTunableNumber("Hood/Goal Tolerance");
