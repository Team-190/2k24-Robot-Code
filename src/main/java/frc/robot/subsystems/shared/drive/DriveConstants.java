    ...
    static {
        switch (Constants.ROBOT) {
            case WHIPLASH:
                ...
                TRACK_WIDTH_X = Math.abs(WhiplashTunerConstants.FrontLeft.LocationX)+ Math.abs(WhiplashTunerConstants.FrontRight.LocationX);
                TRACK_WIDTH_Y = Math.abs(WhiplashTunerConstants.FrontLeft.LocationY)+ Math.abs(WhiplashTunerConstants.BackLeft.LocationY);
                WHEEL_RADIUS = Units.inchesToMeters(2.0);
                MAX_LINEAR_VELOCITY = Units.feetToMeters(15.0);
                DRIVE_BASE_RADIUS =
                Math.max(
                    Math.max(
                        Math.hypot(WhiplashTunerConstants.FrontLeft.LocationX, WhiplashTunerConstants.FrontRight.LocationY),
                        Math.hypot(WhiplashTunerConstants.FrontRight.LocationX, WhiplashTunerConstants.FrontRight.LocationY)),
                    Math.max(
                        Math.hypot(WhiplashTunerConstants.BackLeft.LocationX, WhiplashTunerConstants.BackLeft.LocationY),
                        Math.hypot(WhiplashTunerConstants.BackRight.LocationX, WhiplashTunerConstants.BackRight.LocationY)));
            ...
            case SNAPBACK:
                ...
                TRACK_WIDTH_X = Math.abs(SnapbackTunerConstants.FrontLeft.LocationX)+ Math.abs(SnapbackTunerConstants.FrontRight.LocationX);
                TRACK_WIDTH_Y = Math.abs(SnapbackTunerConstants.FrontLeft.LocationY)+ Math.abs(SnapbackTunerConstants.BackLeft.LocationY);
                WHEEL_RADIUS = Units.inchesToMeters(2.0);
                MAX_LINEAR_VELOCITY = Units.feetToMeters(15.0);
                DRIVE_BASE_RADIUS =
                Math.max(
                    Math.max(
                        Math.hypot(SnapbackTunerConstants.FrontLeft.LocationX, SnapbackTunerConstants.FrontRight.LocationY),
                        Math.hypot(SnapbackTunerConstants.FrontRight.LocationX, SnapbackTunerConstants.FrontRight.LocationY)),
                    Math.max(
                        Math.hypot(SnapbackTunerConstants.BackLeft.LocationX, SnapbackTunerConstants.BackLeft.LocationY),
                        Math.hypot(SnapbackTunerConstants.BackRight.LocationX, SnapbackTunerConstants.BackRight.LocationY)));
                MAX_ANGULAR_VELOCITY = (MAX_LINEAR_VELOCITY / DRIVE_BASE_RADIUS) * 0.6;
                KINEMATICS =
            new SwerveDriveKinematics(
                new Translation2d[] {
